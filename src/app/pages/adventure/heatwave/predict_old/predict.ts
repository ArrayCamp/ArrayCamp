...
export class Predict extends Exercise {
  ...
  readonly question1Answers = signal(shuffle(['1', '2', '3', '4']));
  readonly question1Checked = signal(false);
  readonly question1Correct = signal(false);
  readonly question1Solution = '3';
  ...
  readonly question2Solution = '25°C telt niet mee';
  readonly question2ShowFeedback = signal(false);

  readonly question3Elements = signal(shuffle(['24', '26', '30', '25', '27', '1', '2', '3', '4', '5']));
  ...
  readonly question3Value5 = signal<string[]>([]);
  ...
  readonly question3Index5 = signal<string[]>([]);
  readonly question3DropListMapping = new Map<string, WritableSignal<string[]>>([
    ...
    ['question-3-value-5', this.question3Value5],
    ...
    ['question-3-index-5', this.question3Index5],
  ]);
  ...
  override check(): void {
    ...
    if (
      this.question() === 5 &&
      (this.question3Value1()[0] !== '24' ||
        this.question3Value2()[0] !== '26' ||
        this.question3Value3()[0] !== '30' ||
        this.question3Value4()[0] !== '25' ||
        this.question3Value5()[0] !== '27' ||
        this.question3Index1()[0] !== '1' ||
        this.question3Index2()[0] !== '2' ||
        this.question3Index3()[0] !== '3' ||
        this.question3Index4()[0] !== '4' ||
        this.question3Index5()[0] !== '5')
    ) {
      const incorrectBottomSheetRef = this.bottomSheet.open(IncorrectBottomSheet, {
        data: {
          seeAnswer: true,
      ...
      incorrectBottomSheetRef.afterDismissed().subscribe((result) => {
        if (result === 'see-answer') {
          ...
          this.question3Value1.set(['24']);
          this.question3Value2.set(['26']);
          this.question3Value3.set(['30']);
          this.question3Value4.set(['25']);
          this.question3Value5.set(['27']);
          this.question3Index1.set(['1']);
          this.question3Index2.set(['2']);
          this.question3Index3.set(['3']);
          this.question3Index4.set(['4']);
          this.question3Index5.set(['5']);
          this.checked.set(true);
          this.scrollToBottom();
        }
      });
