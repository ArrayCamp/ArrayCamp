...
export class Run extends Exercise {
  ...
  readonly question1Solution: CodeLine[] = [
    ...
    { index: 9, text: 'intTemp(intI) = CInt(InputBox("Geef max temperatuur op dag " & CStr(intI)))', indent: 8 },
    { index: 10, text: 'Next intI', indent: 4 },
    { index: 11, text: 'intI = 1', indent: 4, valid: [11, 12, 13] },
    { index: 12, text: 'intWarm25 = 0', indent: 4, valid: [11, 12, 13] },
    { index: 13, text: 'intWarm30 = 0', indent: 4, valid: [11, 12, 13] },
