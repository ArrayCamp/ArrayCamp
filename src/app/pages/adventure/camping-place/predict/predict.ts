...
export class Predict extends Exercise {
  ...
  readonly question1Value6 = signal<string[]>([]);
  readonly question1Value6Correct = signal(false);
  readonly question1Value7 = signal<string[]>([]);
  readonly question1Value7Correct = signal(false);
  readonly question1Value8 = signal<string[]>([]);
  readonly question1Value8Correct = signal(false);
  readonly question1Value9 = signal<string[]>([]);
  readonly question1Value9Correct = signal(false);
  readonly question1Value10 = signal<string[]>([]);
  readonly question1Value10Correct = signal(false);
  ...
  readonly question1Index6 = signal<string[]>([]);
  readonly question1Index6Correct = signal(false);
  readonly question1Index7 = signal<string[]>([]);
  readonly question1Index7Correct = signal(false);
  readonly question1Index8 = signal<string[]>([]);
  readonly question1Index8Correct = signal(false);
  readonly question1Index9 = signal<string[]>([]);
  readonly question1Index9Correct = signal(false);
  readonly question1Index10 = signal<string[]>([]);
  readonly question1Index10Correct = signal(false);
  readonly question1DropListMapping = new Map<string, WritableSignal<string[]>>([
    ...
    ['question-1-value-6', this.question1Value6],
    ['question-1-value-7', this.question1Value7],
    ['question-1-value-8', this.question1Value8],
    ['question-1-value-9', this.question1Value9],
    ['question-1-value-10', this.question1Value10],
    ...
    ['question-1-index-6', this.question1Index6],
    ['question-1-index-7', this.question1Index7],
    ['question-1-index-8', this.question1Index8],
    ['question-1-index-9', this.question1Index9],
    ['question-1-index-10', this.question1Index10],
  ]);
  ...
  readonly question2Answers = signal(
    shuffle([
      ...
      'Het nummer van de eerste vrije plaats',
      'De laatst ingegeven plaats',
    ]),
  );
  readonly question2Checked = signal(false);
  readonly question2Correct = signal(false);
  readonly question2Solution = 'Het nummer van de eerste vrije plaats';
  readonly question2ShowFeedback = signal(false);

  readonly question3Answer = model('');
  readonly question3Answers = signal(
    shuffle([
      'De functie krijgt de volledige array boolBezet() binnen',
      'De functie krijgt één element van de array ',
      'De functie past de array aan',
      'De array start bij index 0',
    ]),
  );
  readonly question3Checked = signal(false);
  readonly question3Correct = signal(false);
  readonly question3Solution = 'De functie krijgt de volledige array boolBezet() binnen';
  ...
  override check(): void {
    if (this.question() === 1) {
      ...
      this.question1Value6Correct.set(this.question1Value6()[0] === this.question1Solution[5]);
      this.question1Value7Correct.set(this.question1Value7()[0] === this.question1Solution[6]);
      this.question1Value8Correct.set(this.question1Value8()[0] === this.question1Solution[7]);
      this.question1Value9Correct.set(this.question1Value9()[0] === this.question1Solution[8]);
      this.question1Value10Correct.set(this.question1Value10()[0] === this.question1Solution[9]);
      this.question1Index1Correct.set(this.question1Index1()[0] === this.question1Solution[10]);
      this.question1Index2Correct.set(this.question1Index2()[0] === this.question1Solution[11]);
      this.question1Index3Correct.set(this.question1Index3()[0] === this.question1Solution[12]);
      this.question1Index4Correct.set(this.question1Index4()[0] === this.question1Solution[13]);
      this.question1Index5Correct.set(this.question1Index5()[0] === this.question1Solution[14]);
      this.question1Index6Correct.set(this.question1Index6()[0] === this.question1Solution[15]);
      this.question1Index7Correct.set(this.question1Index7()[0] === this.question1Solution[16]);
      this.question1Index8Correct.set(this.question1Index8()[0] === this.question1Solution[17]);
      this.question1Index9Correct.set(this.question1Index9()[0] === this.question1Solution[18]);
      this.question1Index10Correct.set(this.question1Index10()[0] === this.question1Solution[19]);
      this.question1Correct.set(
        this.question1Value1Correct() &&
          ...
          this.question1Value6Correct() &&
          this.question1Value7Correct() &&
          this.question1Value8Correct() &&
          this.question1Value9Correct() &&
          this.question1Value10Correct() &&
          ...
          this.question1Index6Correct() &&
          this.question1Index7Correct() &&
          this.question1Index8Correct() &&
          this.question1Index9Correct() &&
          this.question1Index10Correct(),
      );
      ...
      if (!this.question1Correct()) {
        ...
        incorrectBottomSheetRef.afterDismissed().subscribe((result) => {
          if (result === 'see-answer') {
            ...
            this.question1Value6.set([this.question1Solution[5]]);
            this.question1Value7.set([this.question1Solution[6]]);
            this.question1Value8.set([this.question1Solution[7]]);
            this.question1Value9.set([this.question1Solution[8]]);
            this.question1Value10.set([this.question1Solution[9]]);
            this.question1Index1.set([this.question1Solution[10]]);
            this.question1Index2.set([this.question1Solution[11]]);
            this.question1Index3.set([this.question1Solution[12]]);
            this.question1Index4.set([this.question1Solution[13]]);
            this.question1Index5.set([this.question1Solution[14]]);
            this.question1Index6.set([this.question1Solution[15]]);
            this.question1Index7.set([this.question1Solution[16]]);
            this.question1Index8.set([this.question1Solution[17]]);
            this.question1Index9.set([this.question1Solution[18]]);
            this.question1Index10.set([this.question1Solution[19]]);
