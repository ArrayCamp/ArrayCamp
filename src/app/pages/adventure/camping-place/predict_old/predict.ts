...
export class Predict extends Exercise {
  ...
  readonly question1Answers = signal(
    shuffle([
      'Altijd 0',
  ...
  readonly question1Solution = 'Het nummer van de eerste vrije plaats';
  ...
  readonly question2Solution = 'De functie krijgt de volledige array boolBezet() binnen';
  readonly question2ShowFeedback = signal(false);

  readonly question3Elements = signal(shuffle(['Tent', 'Slaapzak', 'Zwemshort', '1', '2', '3']));
  ...
  override check(): void {
    ...
    if (
      this.question() === 3 &&
      (this.question3Value1()[0] !== 'Tent' ||
        this.question3Value2()[0] !== 'Slaapzak' ||
        this.question3Value3()[0] !== 'Zwemshort' ||
      ...
      incorrectBottomSheetRef.afterDismissed().subscribe((result) => {
        if (result === 'see-answer') {
          ...
          this.question3Value1.set(['Tent']);
          this.question3Value2.set(['Slaapzak']);
          this.question3Value3.set(['Zwemshort']);
