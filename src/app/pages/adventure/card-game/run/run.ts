...
export class Run extends Exercise {
  ...
  readonly question1Solution: CodeLine[] = [
    ...
    { index: 3, text: 'Const AANTAL As Integer = 4', indent: 4, valid: [3, 4, 5, 6] },
    { index: 4, text: 'Dim intKaartenTrekken(AANTAL) As Integer', indent: 4, valid: [3, 4, 5, 6] },
    { index: 5, text: 'Dim intI As Integer', indent: 4, valid: [3, 4, 5, 6] },
    { index: 6, text: 'Dim strTekst As String', indent: 4, valid: [3, 4, 5, 6] },
    { index: 7, text: 'strTekst = "kaarten leggen:" & vbNewLine', indent: 4 },
    { index: 8, text: 'For intI = 1 To AANTAL', indent: 4 },
    { index: 9, text: 'intKaartenTrekken(intI) = intI * 2', indent: 8 },
    {
      index: 10,
      text: 'strTekst = strTekst & "Speler " & CStr(intI) & " legt: +" & CStr(intKaartenTrekken(intI)) & " kaarten." & vbNewLine',
      indent: 8,
    },
    { index: 11, text: 'Next intI', indent: 4 },
    { index: 12, text: 'MsgBox strTekst', indent: 4 },
    { index: 13, text: 'End Sub' },
  ];
