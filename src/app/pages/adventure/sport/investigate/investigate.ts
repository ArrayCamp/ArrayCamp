...
export class Investigate extends Exercise {
  ...
  readonly question1: CodeLine[] = [
    ...
    { index: 2, text: 'Sub INVESTIGATE_Sport()' },
    { index: 3, text: 'Const AANTAL As Integer = 3', indent: 4 },
    { index: 4, text: 'Dim strSport(AANTAL) As String', indent: 4 },
    { index: 5, text: 'Dim intCalPerMin(AANTAL) As Integer', indent: 4 },
    { index: 6, text: 'Dim intI As Integer', indent: 4 },
    { index: 7, text: 'Dim intDoel As Integer', indent: 4 },
    { index: 8, text: 'Dim intKeuze As Integer', indent: 4 },
    { index: 9, text: 'Dim intMinuten As Integer', indent: 4 },
    { index: 10, text: 'intDoel = 500', indent: 4 },
    { index: 11, text: 'intI = 1', indent: 4 },
    { index: 12, text: 'Do While intI <= AANTAL', indent: 4 },
    { index: 13, text: 'strSport(intI) = InputBox("Geef sport " & intI)', indent: 8 },
    { index: 14, text: 'strSport(intI) = InputBox("Geef cal/min voor " & strSport(intI))', indent: 8 },
    { index: 15, text: 'intI = intI + 1', indent: 8 },
    { index: 16, text: 'Loop', indent: 4 },
    { index: 17, text: 'intKeuze = InputBox("Welke sport kies je? (1-" & AANTAL & ")")', indent: 4 },
    { index: 18, text: 'intMinuten = intDoel / intCalPerMin(intKeuze)', indent: 4 },
    { index: 19, text: 'MsgBox "Je moet " & intMinuten & " minuten " & strSport(intKeuze) & " doen."', indent: 4 },
    { index: 20, text: 'End Sub' },
  ];
