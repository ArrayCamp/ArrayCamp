...
export class Run extends Exercise {
  ...
  readonly question1Solution: CodeLine[] = [
    ...
    { index: 2, text: 'Sub Sport()' },
    { index: 3, text: 'Const AANTAL As Integer = 3', indent: 4, valid: [3, 4, 5, 6, 7] },
    { index: 4, text: 'Dim strAct(AANTAL) As String', indent: 4, valid: [3, 4, 5, 6, 7] },
    { index: 5, text: 'Dim intCalPerMin(AANTAL) As Integer', indent: 4, valid: [3, 4, 5, 6, 7] },
    { index: 6, text: 'Dim intI As Integer', indent: 4, valid: [3, 4, 5, 6, 7] },
    { index: 7, text: 'Dim strTekst As String', indent: 4, valid: [3, 4, 5, 6, 7] },
    { index: 8, text: 'Do While intI <= AANTAL', indent: 4 },
    { index: 9, text: 'strAct(intI) = InputBox("Geef naam van activiteit " & CStr(intI))', indent: 8 },
    { index: 10, text: 'intCalPerMin(intI) = CInt(InputBox("Calorieën per minuut voor " & strAct(intI)))', indent: 8 },
    {
      index: 11,
      text: 'strTekst = strTekst & "- " & strAct(intI) & ": " & CStr(intCalPerMin(intI)) & " cal/min" & vbNewLine',
      indent: 8,
    },
    { index: 12, text: 'intI = intI + 1', indent: 8 },
    { index: 13, text: 'Loop', indent: 4 },
