...
export class Modify extends Exercise implements OnInit {
  ...
  readonly question1Solution = 'intCalPerMin(intI) = InputBox("Geef cal/min voor " & strSport(intI))';
  readonly question1ShowFeedback = signal(false);

  ngOnInit(): void {
    this.question1Answer.set('strSport(intI) = InputBox("Geef cal/min voor " & strSport(intI))');
  }
