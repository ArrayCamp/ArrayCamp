...
export class Predict extends Exercise {
  ...
  readonly question1Solution = 'De activiteit en cal/min die bij index 2 horen';
  ...
  readonly question2Solution = 'strAct(2) en intCalPerMin(2) horen bij dezelfde activiteit';
  readonly question2ShowFeedback = signal(false);

  readonly question3Elements = signal(shuffle(['Lopen', 'Fietsen', 'Zwemmen', '1', '2', '3']));
