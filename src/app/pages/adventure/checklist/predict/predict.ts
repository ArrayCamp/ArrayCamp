...
export class Predict extends Exercise {
  ...
  readonly question1Solution = ['Tent', 'Slaapzak', 'Zwemkledij', '1', '2', '3'];
  ...
  readonly question2Answers = signal(shuffle(['Tent', 'Slaapzak', 'Zwemkledij', 'Tent Slaapzak Zwemkledij']));
  readonly question2Checked = signal(false);
  readonly question2Correct = signal(false);
  readonly question2Solution = 'Slaapzak';
  readonly question2ShowFeedback = signal(false);

  readonly question3Answer = model('');
  readonly question3Answers = signal(
    shuffle([
      'De array boodschappen begint bij index 0',
      'De array boodschappen begint bij index 1',
      'De array boodschappen heeft 4 elementen',
      'De array boodschappen is leeg',
    ]),
  );
  readonly question3Checked = signal(false);
  readonly question3Correct = signal(false);
  readonly question3Solution = 'De array boodschappen begint bij index 1';
  ...
  override check(): void {
    if (this.question() === 1) {
      ...
      this.question1Index1Correct.set(this.question1Index1()[0] === this.question1Solution[3]);
      this.question1Index2Correct.set(this.question1Index2()[0] === this.question1Solution[4]);
      this.question1Index3Correct.set(this.question1Index3()[0] === this.question1Solution[5]);
      ...
      if (!this.question1Correct()) {
        ...
        incorrectBottomSheetRef.afterDismissed().subscribe((result) => {
          if (result === 'see-answer') {
            ...
            this.question1Index1.set([this.question1Solution[3]]);
            this.question1Index2.set([this.question1Solution[4]]);
            this.question1Index3.set([this.question1Solution[5]]);
